...
public class sucKhoeLamDepAdapter extends RecyclerView.Adapter<sucKhoeLamDepAdapter.ViewHolder> {
    ...
    public sucKhoeLamDepAdapter(Context context, ArrayList<sanPham> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View itemView = inflater.inflate(R.layout.list_suckhoelamdep, viewGroup, false);
