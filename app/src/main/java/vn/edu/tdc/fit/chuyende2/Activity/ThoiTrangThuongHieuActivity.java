...
public class ThoiTrangThuongHieuActivity extends AppCompatActivity {
    ...
    public void importSanPham() {
        dssp.add(new sanPham(21, R.drawable.thoitrangmot, "ÁO KHOÁC NAM - ÁO KHOÁC NAM - ÁO KHOÁC NAM313", 690000, "Áo giữ nhiệt dành cho nam giới\n" +
                ...
                "\n", 21));
        dssp.add(new sanPham(22, R.drawable.thoitranghai, "Áo sơ mi nam dài tay màu đen", 99000, "Facioshop - Sinh ra để dẫn dắt xu hướng thời trang (Born to lead the fashion trend)\n" +
                "\n" +
        ...
        dssp.add(new sanPham(25, R.drawable.sanphamnam, "Áo Khoác Jeans Nam In Sành Điệu - aokhoacnam-1", 175000 , "Bạn cần hướng dẫn cách thức đặt hàng , mà bạn có rất ít thời gian , hay cần tư vấn trực tiếp hãy gọi  hoặc zalo 0974511076   dc tư vấn  nhanh\n" +
        ...
        dssp.add(new sanPham(26, R.drawable.sanphamsau, "áo khoác jeans rách fashion Mã: NK1250 - NK1250", 310000, "Chất vải: Voan.\n" +
        ...
        dssp.add(new sanPham(27, R.drawable.thoitrangbon, "Áo Sơ Mi Công Sở Đính Trân Châu - RR154", 197000 , "Chất Liệu : Cotton Thun\n" +
        ...
        dssp.add(new sanPham(28, R.drawable.thoitrangtam, "BỘ ĐỒ THỂ THAO NỮ PHỐI SỌC - m105", 99000, "ĐẦM SUÔNG PHỐI REN 2 LỚP - DCS61\n" +
        ...
        dssp.add(new sanPham(29, R.drawable.thoitrangchin, "MIỄN SHIP TOÀN QUỐC- Bộ đồ lửng form dài áo cách điệu BDL125 - BDL125", 175000 , "ĐẦM GIÚP BỤNG TRÔNG THON GỌN - THỜI TRÁNG BIG SIZE\n" +
                "\n" +
        ...
        dssp.add(new sanPham(30, R.drawable.thoitrangbay, "Áo hai dây nữ - A005", 39000, "Đầm Voan Suông Họa Tiết Thêu HR1464\n" +
                "\n" +
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menugiohang:
                Intent intent = new Intent(ThoiTrangThuongHieuActivity.this, cartActivity.class);
