...
public class thoiTrangThuongHieuAdapter extends RecyclerView.Adapter<thoiTrangThuongHieuAdapter.ViewHolder> {
    ...
    public thoiTrangThuongHieuAdapter(Context context, ArrayList<sanPham> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View itemView = inflater.inflate(R.layout.list_thoitrangthuonghieu, viewGroup, false);
